...
namespace Selling_Website.Migrations
{
    ...
    [Migration("20201031123753_Add_Full_Table")]
    partial class Add_Full_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Selling_Website.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Selling_Website.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Selling_Website.Entities.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Selling_Website.Entities.OrderDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Selling_Website.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Selling_Website.Entities.Order", b =>
                {
                    b.HasOne("Selling_Website.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Selling_Website.Entities.OrderDetail", b =>
                {
                    b.HasOne("Selling_Website.Entities.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderID");

                    b.HasOne("Selling_Website.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Selling_Website.Entities.Product", b =>
                {
                    b.HasOne("Selling_Website.Entities.Category", "Category")
                        .WithMany("Products")
