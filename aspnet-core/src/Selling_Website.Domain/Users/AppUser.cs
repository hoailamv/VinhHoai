...
namespace Selling_Website.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update Selling_WebsiteDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update Selling_WebsiteEfCoreEntityExtensionMappings to extend the IdentityUser entity
